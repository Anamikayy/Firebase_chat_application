...
const Register = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        const coloIndex = Math.floor(Math.random() * profileColors.length)
    ...
    <Loader/> 
        ...
        <div className="h-[100vh] flex justify-center items-center bg-c1">
            ...
            <form onSubmit={handleSubmit}className="flex flex-col items-center gap-3 w-[500px] mt-5">
                ...
                <button className="mt-4 w-full h-14 rounded-xl outline-none text-base bg-gradient-to-r from-indigo-800 via-purple-800 to-pink-800">Sign Up</button>
            </form> 
