    ...
    const resetPassword = async () => {
        try {
            ...
            }, 
            {
                ...
                success: "Reset email send on your registered email id.",
    ...
    return isLoading || (!isLoading && currentUser)? (
        ...
        <div className="h-[100vh] flex justify-center items-center bg-c1">
            ...
            >
                ...
                <button className="mt-4 w-full h-14 rounded-xl outline-none text-base bg-gradient-to-r from-indigo-800 via-purple-800 to-pink-800">Login to Your Account</button>
            </form> 
